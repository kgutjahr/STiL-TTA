...
class MultimodalBackbone(nn.Module):
    ...
    def __init__(self, args) -> None:
        ...
        self.tabular_proj = nn.Linear(args.tabular_embedding_dim, args.multimmodal_embedding_dim) if args.tabular_embedding_dim != args.multimodal_embedding_dim else nn.Identity()
        if args.pretrain == True and args.checkpoint is None:
            ...
            self.classifier_tabular = nn.Linear(args.tabular_embedding_dim, args.num_classes)
        if args.checkpoint: 
