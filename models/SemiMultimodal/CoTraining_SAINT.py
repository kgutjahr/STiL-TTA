'''
CoTraining with SAINT's tabular encoder, pytorch lightning module
'''
...
from models.SemiMultimodal.Multimodal_model_SAINT import MultimodalBackbone
