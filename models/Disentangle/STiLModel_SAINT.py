...
Use SAINT as the tabular encoder
'''
...
from models.Disentangle.utils.STiLModel_SAINT_backbone import DisCoAttentionBackbone
...
class SemiDisCoPseudoSmooth(pl.LightningModule):
    def __init__(self, hparams):
        super().__init__()
        self.save_hyperparameters(hparams)

        self.model = DisCoAttentionBackbone(self.hparams)
        print('Use STiLModel_SAINT.py')
    ...
    def momentum_update_ema(self):
        if self.eman:
            ...
            for (k_main, v_main), (k_ema, v_ema) in zip(state_dict_main.items(), state_dict_ema.items()):
                ...
                if 'num_batches_tracked' in k_ema or 'offset' in k_ema:
    ...
    def training_epoch_end(self, _) -> None:
        ...
        with torch.no_grad():
            ...
            # self.print(f'Zero count in prototypes: {zero_count}')
