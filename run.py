...
def run(args: DictConfig):
  ...
  if args.host == 'cq':
    ...
    # args.imaging_pretrained_path = args.imaging_pretrained_path_cq
  elif args.host == 'bio':
    args.data_base = args.data_base_bio
    # args.imaging_pretrained_path = args.imaging_pretrained_path_bio
  elif args.host == 'hpc':
    args.data_base = args.data_base_hpc
    # args.imaging_pretrained_path = args.imaging_pretrained_path_hpc
  else:
    assert print('Unknown host')
